...
def main():
	parser = ArgumentParser(
        ...
        epilog='''
Example:
   python3 joy-ddos.py -d www.example.com -p 80 -T 2000 -Pyslow
   python3 joy-ddos.py -d www.domain.com -s 100 -Request
   python3 joy-ddos.py -d www.google.com -Synflood -T 5000 -t 10.0
'''
)
